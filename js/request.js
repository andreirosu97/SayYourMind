                    ...
                    $.ajax({
                        ...
                        success: function(userData) {
                            ...
                            var succsess_notif = $.notify({
                                ...
                                onClosed: function() {
                                    console.log("Request published." + userData.result.reqid);
                                    document.getElementById('linkOut').value =
                                        "https://sayyourmind.com/answertome.php?user=" + hex_sha512(userData.result.uid) + "&req=" + hex_sha512(userData.result.reqid);
                                }
                            });
